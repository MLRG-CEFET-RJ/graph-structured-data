...
with open(os.path.join(os.path.dirname(__file__), 'test_data3.pickle'), 'wb') as f:
...
class CustomLoss(torch.nn.Module):
    ...
    def loss_repeated_labels(self, output):
      ...
      return torch.var(counts, unbiased=False) + (output.shape[0] - counts.shape[0])**2
...
class EarlyStopping:
    ...
    def save_checkpoint(self, val_loss, model):
        ...
        path = os.path.join(os.path.dirname(__file__), 'checkpoint3.pt')
